...
const Modal = ({ open, setOpen, title, content, lowerContent,neverCloseModal }: ModalProps) => {
                ...
                <div className="flex sm:min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                    ...
                    >
                        <Dialog.Panel className="relative transform w-full overflow-hidden bg-white text-left  border border-slate-200 rounded-2xl shadow-2xl  box-border transition-all sm:my-8 sm:max-w-lg">
                            <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                ...
                                <div className="">
                                    ...
                                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                        <Dialog.Title as="h3" className="text-center text-xl font-black leading-6 text-gray-900">
                                            {title}
                                        </Dialog.Title>
                                        <div className="mt-2">
                                            {content}
                            ...
                            <div className="border-t  border-t-blue-400 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                                {lowerContent}
                            </div>
                        </Dialog.Panel>
                    </Transition.Child>
                    ...
                    <div className="flex sm:min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                        ...
                        >
                            <Dialog.Panel className="relative transform w-full overflow-hidden bg-white text-left  border border-slate-200 rounded-2xl shadow-2xl  box-border transition-all sm:my-8 sm:max-w-lg">
                                <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                    <Dialog.Title as="h3" className="text-base font-semibold leading-6 text-gray-900">
                                        <FaTimes onClick={() => setOpen(false)} className={"absolute right-3 top-3 text-xl text-red-500 hover:text-red-800"} />
                                    </Dialog.Title>
                                    <div className="">
